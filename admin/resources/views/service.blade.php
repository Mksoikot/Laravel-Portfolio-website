    ...
    <div id="mainDiv" class="container d-none">
        <div class="row">
            <div class="col-md-12 p-5">
                <button id="addNewBtnId" style="float: right;font-size: 12px;" class="btn my-2 btn-sm btn-danger"> <i
            ...
            <div class="modal-content">
                <div class="modal-body p-4 text-center">
                    <div id="serviceAddForm" class="w-100">
                        ...
                        <input type="text" id="serviceImgAddID" class="form-control mb-4"
