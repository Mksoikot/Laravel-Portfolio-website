...
$('#contactSendBtnId').click(function() {
    ...
    ContactSend(contactName, contactMobile, contactEmail, contactMsg);
});
...
function ContactSend(contact_name, contact_mobile, contact_email, contact_msg) {
    ...
    if (contact_name.length == 0) {
        ...
        $('#contactSendBtnId').html('আপনার বার্তা লিখুন...');
        setTimeout(function() {
            $('#contactSendBtnId').html('পাঠিয়ে দিন');
        }, 2000);
    } else {
            ...
            .then(function(response) {
                if (response.status == 200) {
                    if (response.data == 1) {
                        ...
                        $('#contactSendBtnId').html('অনুরোধ বার্থ হয়েছে,আবার চেষ্টা করুন');
                        setTimeout(function() {
                            $('#contactSendBtnId').html('পাঠিয়ে দিন');
                        }, 3000);
                    }
